...
-DpushChanges=false && \
mvn org.apache.maven.plugins:maven-release-plugin:2.1:perform -Darguments="-DaltDeploymentRepository=$MVN_RELEASE_REPO" -Prelease -DlocalCheckout=true -Dmaven.test.skip=true \
-DpushChanges=false && \
